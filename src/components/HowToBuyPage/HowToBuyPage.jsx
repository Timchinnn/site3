      ...
      <div className="images-container">
        ...
        <div className="parent">
          <img
            ...
            onClick={() => navigate(-1)}
          />
          <div className="garant-description-page">
            {" "}
            <div className="garant-description">
              <p className="storage-facilities-description">
                Складские и производственные помещения компании соответствуют
                всем техническим требованиям и необходимым условиям для хранения
                и подготовки банковского оборудования.
              </p>
            </div>
            ...
            <div className="garant-description">
              <ul className="company-advantages-list">
                ...
                <li>
                  ...
                  видеонаблюдения, постановка всего комплекса на
