    ...
    <div className="modal-overlay1">
      <div className="images-container">
        ...
        <div className="parent">
          ...
          <p className="loyal-p-over">
            Для оказания качественных услуг компания имеет в своем распоряжении:
            ...
            имеющих  Многолетний опыт ремонтных работ, предпродажной подготовки
            и восстановительных работ.  Наличие такелажного оборудования и
            сертифицированных специалистов, что позволяет вести работы с любой
            габаритной техникой.
          </p>
          <p className="loyal-p-over">
            Склады и производственные цеха отвечают необходимым стандартам
            хранения и эксплуатации:  Наличие освещения, отопления и
            приточно-вытяжной вентиляции;  Контроль температуры и влажности;
            ...
            охрану;  Страхование всего оборудования, размещенного на хранение;
              Наличие внутренней парковочной зоны, рассчитанной на любые виды
            автотранспорта.
          </p>
        </div>
      </div>
